process ARRIBA_DOWNLOAD {
    ...
    tar -xzvf blacklist_hg38_GRCh38_v${arriba_version}.tsv.gz blacklist_hg38_GRCh38_v${arriba_version}.tsv
    tar -xzvf known_fusions_hg38_GRCh38_v${arriba_version}.tsv.gz known_fusions_hg38_GRCh38_v${arriba_version}.tsv
